...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-c2m8*ks*3wwlk+(2f8#8w(aab^lsgrp@9%%db*%=aqqxe_u)z('
...
# Penyesuaian message tags dengan bootstrap: error - danger
MESSAGE_TAGS = {
...
EMAIL_HOST_USER = "t64052064@gmail.com"
EMAIL_USE_TLS = True
